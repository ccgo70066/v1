define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'api/field/index' + location.search,
                    add_url: 'api/field/add',
                    edit_url: 'api/field/edit',
                    del_url: 'api/field/del',
                    multi_url: 'api/field/multi',
                    import_url: 'api/field/import',
                    table: 'api_field',
                }
            });
