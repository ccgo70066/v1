define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'api/route/index' + location.search,
                    add_url: 'api/route/add',
                    edit_url: 'api/route/edit',
                    del_url: 'api/route/del',
                    multi_url: 'api/route/multi',
                    import_url: 'api/route/import',
                    table: 'api_route',
                }
            });
