define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'wheel/config_sys/index/box_type/'+Fast.api.query('box_type')+'/count_type/'+Fast.api.query('count_type') + location.search,
                    add_url: 'wheel/config_sys/add/box_type/'+Fast.api.query('box_type')+'/count_type/'+Fast.api.query('count_type'),
                    edit_url: 'wheel/config_sys/edit/box_type/'+Fast.api.query('box_type')+'/count_type/'+Fast.api.query('count_type'),
                    del_url: 'wheel/config_sys/del',
                    multi_url: 'wheel/config_sys/multi',
                    detail_url: 'wheel/config_sys/index',
                    table: 'wheel_config_sys',
                }
            });
