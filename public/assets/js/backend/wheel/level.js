define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'wheel/level/index/box_type/'+Fast.api.query('box_type') + location.search,
                    add_url: 'wheel/level/add/box_type/'+Fast.api.query('box_type'),
                    edit_url: 'wheel/level/edit/box_type/'+Fast.api.query('box_type'),
                    del_url: 'wheel/level/del',
                    multi_url: 'wheel/level/multi',
                    detail_url: 'wheel/level/index',
                    table: 'wheel_level',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'upgrade_gift_text', title: __('upgrade_gift_ids'), operate: false, formatter: Table.api.formatter.label},
                        ...
                        {field: 'or_data', title: __('Or_data'), searchList: {"1":__('Or_data 1'),"2":__('Or_data 2')}, formatter: Table.api.formatter.normal},
