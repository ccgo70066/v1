define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'wheel/setting/index',
                    add_url: 'wheel/setting/add',
                    edit_url: 'wheel/setting/edit',
                    del_url: 'wheel/setting/del',
                    multi_url: 'wheel/setting/multi',
                    table: 'config',
                }
            });
