define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'wheel/log_mongo_h/index' + location.search,
                    sum_url: 'wheel/log_mongo_h/sum' + location.search,
                    detail_url: 'wheel/log_mongo_h/index',
                    table: 'wheel_log',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'log.level_id', title: __('Level_id'), operate: false, searchList: $.getJSON('wheel/log/index/option/load_level/'), formatter: function (value, row, index) {
                                return row.level_name;
                            }},
                        {field: 'used_amount', title: __('Used_amount'), operate: false, formatter: function (value, row, index) {
                                return value;
                            }},
                        {field: 'log.gift_id', title: __('礼物'), searchList: $.getJSON('wheel/log/index/option/load_gift'), formatter: function (value, row, index) {
                        ...
                        {field: 'log.weigh_name', title: __('Weigh_name'), operate: false, searchList: $.getJSON('wheel/log/index/option/load_weigh')},
                        {field: 'log.jump_status', title: __('Jump_status'),operate:false, searchList: {0:__('Jump_status 0'),1:__('Jump_status 1'),2:__('Jump_status 2'),3:__('Jump_status 3'),4:__('Jump_status 4'),5:__('Jump_status 5'),6:__('Jump_status 6')}, formatter: Table.api.formatter.status},
