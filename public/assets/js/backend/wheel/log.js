define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'wheel/log/index' + location.search,
                    sum_url: 'wheel/log/sum' + location.search,
                    add_url: 'wheel/log/add',
                    edit_url: 'wheel/log/edit',
                    del_url: 'wheel/log/del',
                    multi_url: 'wheel/log/multi',
                    detail_url: 'wheel/log/index',
                    table: 'wheel_log',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        // {checkbox: true},
                        // {field: 'aa_egg_log.id', title: __('Id'), formatter: function (value, row, index) { return row.id; }},
                        ...
                        {field: 'level_id', title: __('Level_id'), operate: '=', searchList: $.getJSON('wheel/log/index/option/load_level/'), formatter: function (value, row, index) {
                                return row.level_name;
                            }},
                        {field: 'used_amount', title: __('Used_amount'), operate: false, formatter: function (value, row, index) {
                                return parseFloat(value);
                            }},
                        {field: 'gift_id', title: __('礼物'), searchList: $.getJSON('wheel/log/index/option/load_gift'), formatter: function (value, row, index) {
                        ...
                        {field: 'box_index', title: __('序号'), operate: false},
                        {field: 'weigh_name', title: __('Weigh_name'), operate: '=', searchList: $.getJSON('wheel/log/index/option/load_weigh')},
                        ...
                        {field: 'create_time', title: __('Create_time'), operate: 'range', addclass:'datetimerange', formatter: Table.api.formatter.datetime, autocomplete: false},
                        // {field: 'aa_wheel_log.create_time', title: __('Create_time'), visible: false, operate:'RANGE', addclass:'datetimerange', formatter: Table.api.formatter.datetime,   data: 'data-time-picker="true"',  defaultValue: Controller.api.getDay(-7)},
