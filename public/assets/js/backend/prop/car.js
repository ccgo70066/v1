define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'prop/car/index' + location.search,
                    add_url: 'prop/car/add',
                    edit_url: 'prop/car/edit',
                    del_url: 'prop/car/del',
                    multi_url: 'prop/car/multi',
                    import_url: 'prop/car/import',
                    table: 'car',
                }
            });
