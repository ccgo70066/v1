define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'prop/adornment/index' + location.search,
                    add_url: 'prop/adornment/add',
                    edit_url: 'prop/adornment/edit',
                    del_url: 'prop/adornment/del',
                    multi_url: 'prop/adornment/multi',
                    import_url: 'prop/adornment/import',
                    table: 'adornment',
                }
            });
