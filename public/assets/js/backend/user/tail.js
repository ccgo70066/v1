define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'user/tail/index' + location.search,
                    add_url: 'user/tail/add',
                    edit_url: 'user/tail/edit',
                    del_url: 'user/tail/del',
                    multi_url: 'user/tail/multi',
                    import_url: 'user/tail/import',
                    table: 'user_tail',
                }
            });
                ...
                columns: [
                    [
                       /* {checkbox: true},
                        ...
                        {field: 'tail.name', title: __('tail_id'),operate: false},
