define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'user/adornment/index' + location.search,
                    add_url: 'user/adornment/add',
                    edit_url: 'user/adornment/edit',
                    del_url: 'user/adornment/del',
                    multi_url: 'user/adornment/multi',
                    import_url: 'user/adornment/import',
                    table: 'user_adornment',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'adornment.name', title: __('Adornment_id'),operate: false},
