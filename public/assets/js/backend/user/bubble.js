define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'user/bubble/index' + location.search,
                    add_url: 'user/bubble/add',
                    edit_url: 'user/bubble/edit',
                    del_url: 'user/bubble/del',
                    multi_url: 'user/bubble/multi',
                    import_url: 'user/bubble/import',
                    table: 'user_bubble',
                }
            });
                ...
                columns: [
                    [
                       /* {checkbox: true},
                        ...
                        {field: 'bubble.name', title: __('Bubble_id'),operate: false},
