define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'egg/log_mongo/index' + location.search,
                    sum_url: 'egg/log_mongo/sum' + location.search,
                    detail_url: 'egg/log_mongo/index',
                    table: 'egg_log',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'log.level_id', title: __('Level_id'), operate: '=', searchList: $.getJSON('egg/log_mongo/index/option/load_level/'), formatter: function (value, row, index) {
                                return row.level_name;
                            }},
                        {field: 'used_amount', title: __('Used_amount'), operate: false, formatter: function (value, row, index) {
                                return value;
                            }},
                        {field: 'log.gift_id', title: __('礼物'), searchList: $.getJSON('egg/log_mongo/index/option/load_gift'), formatter: function (value, row, index) {
                        ...
                        {field: 'log.weigh_name', title: __('Weigh_name'), operate: '=', searchList: $.getJSON('egg/log_mongo/index/option/load_weigh')},
