define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'fishv2/setting/index',
                    add_url: 'fishv2/setting/add',
                    edit_url: 'fishv2/setting/edit',
                    del_url: 'fishv2/setting/del',
                    multi_url: 'fishv2/setting/multi',
                    table: 'config',
                }
            });
