define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'egg/gift/index/box_type/'+Fast.api.query('box_type') + location.search,
                    add_url: 'egg/gift/add/box_type/'+Fast.api.query('box_type'),
                    edit_url: 'egg/gift/edit/box_type/'+Fast.api.query('box_type'),
                    del_url: 'egg/gift/del',
                    multi_url: 'egg/gift/multi',
                    detail_url: 'egg/gift/index',
                    table: 'egg_gift',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        // {field: 'x_percent', title: __('X_percent'), operate:false, formatter: function (value, row, index) {
                        //         return value+'%';
                        //     }},
