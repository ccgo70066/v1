...
return [
    ...
    // 获取IP的变量
    'http_agent_ip'           => 'REMOTE_ADDR',  // HTTP_X_FORWARDED_FOR
    // +----------------------------------------------------------------------
    // | 模块设置
    // +----------------------------------------------------------------------
    // 默认模块名
    ...
    // 路由配置文件（支持配置多个）
    'route_config_file'       => ['route', 'route_confuse'],
    // 是否强制使用路由
    ...
    'cache'                   => [
        'type'    => 'complex',
        'default' => [
            'type'   => Env::get('cache.default_type', 'file'),
            'path'   => CACHE_PATH,
            'prefix' => 'tt_'
        ],
        'file'    => [
        ...
        'redis'   => [
            //'type'     => 'redis',
            'type'     => '\\app\\common\\driver\\cache\\Redis',  // 使用自定义Redis驱动（支持自动重连）
            'host'     => Env::get('redis.host', '127.0.0.1'),
            'password' => Env::get('redis.password', '123456'),
            'prefix'   => Env::get('redis.prefix', 't:'),
            'port'     => 6379,
            'expire'   => 0, // 缓存有效期:0=永久缓存
            'select'   => Env::get('redis.select', 5),
        ],
    ],
    // +----------------------------------------------------------------------
    // | 会话设置
    ...
    'token'                   => [
        ...
        'type'     => 'Mysql',
        // 缓存前缀
        'key'      => '4jBhqsx9TL1KwEd7Zkl0HzceP3pNb6Jo',
        // 加密方式
        'hashalgo' => 'ripemd160',
        // 缓存有效期 0表示永久缓存
        'expire'   => 0,
    ...
    'fastadmin'               => [
        ...
        //登录验证码
        'login_captcha'              => false,
        'login_google_authenticator' => Env::get('app.login_google_authenticator', false),
        //登录失败超过10次则1天后重试
