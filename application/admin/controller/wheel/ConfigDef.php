...
{
    // php think crud -t wheel_config_def -m wheelConfigDef -c wheel/configDef -u 1 -f 1
    /**
     * EggConfigSys模型对象
     * @var \app\admin\model\WheelConfigDef
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\WheelConfigDef;
