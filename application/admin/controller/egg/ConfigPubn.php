...
class ConfigPubn extends Backend
{
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\EggConfigPubn;
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax()) {
            ...
            $key = 'pool:egg:pubn_' . input('box_type');
        ...
        if ($this->request->isPost()) {
            ...
            if ($params) {
                ...
                try{
                    ...
                    Game1Service::weigh_title_unique($params['title'], 'pubn', $ids ?? 0);
