 ...
 * @icon fa fa-circle-o
 */
class ConfigBase extends Backend
{
    // php think crud -t egg_config_base -m eggConfigBase -c egg/configBase -u 1 -f 1
    /**
     * EggConfigSys模型对象
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\EggConfigBase();
        ...
        if ($this->request->isPost()) {
            ...
            if ($params) {
                ...
                try{
                    ...
                    \app\common\model\Egg::weigh_title_unique($params['title'], 'base', $ids ?? 0);
