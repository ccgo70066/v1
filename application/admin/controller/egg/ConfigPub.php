...
{
    //php think crud -t egg_config_pub -m eggConfigPub -c egg/configPub -u 1 -f 1
    /**
     * EggConfigSys模型对象
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\EggConfigPub();
    ...
    public function index()
    {
        ...
        if ($this->request->isAjax()) {
            ...
            $key = 'pool:egg:pub_' . input('box_type');
        ...
        if ($this->request->isPost()) {
            ...
            if ($params) {
                ...
                try{
                    ...
                    \app\common\model\Egg::weigh_title_unique($params['title'], 'pub', $ids ?? 0);
