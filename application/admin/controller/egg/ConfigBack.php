 ...
 * @icon fa fa-circle-o
 */
class ConfigBack extends Backend
{

    /**
     * EggConfigBack模型对象
     * @var \app\admin\model\EggConfigBack
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\EggConfigBack;
        ...
        if ($this->request->isPost()) {
            ...
            if ($params) {
                ...
                try{
                    ...
                    Game1Service::weigh_title_unique($params['title'], 'back', $ids ?? 0);
