 ...
 * @icon fa fa-circle-o
 */
class ConfigPer extends Backend
{
    //php think crud -t egg_config_per -m eggConfigPer -c egg/configPer -u 1 -f 1
    /**
     * EggConfigSys模型对象
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\EggConfigPer;
        ...
        if ($this->request->isPost()) {
            ...
            if ($params) {
                ...
                try{
                    ...
                    \app\common\model\Egg::weigh_title_unique($params['title'], 'per', $ids ?? 0);
