 ...
 * @icon fa fa-circle-o
 */
class ChatForbid extends Backend
{

    /**
     * EggChatForbid模型对象
     * @var \app\admin\model\EggChatForbid
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\EggChatForbid;
