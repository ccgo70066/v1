 ...
 * @icon fa fa-circle-o
 */
class ConfigSingle extends Backend
{
    // php think crud -t egg_config_single -m eggConfigSingle -c egg/configSingle -u 1 -f 1
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\EggConfigSingle();
        ...
        if ($this->request->isPost()) {
            ...
            if ($params) {
                ...
                try {
                    ...
                    \app\common\model\Egg::weigh_title_unique($params['title'], 'single', $ids ?? 0);
